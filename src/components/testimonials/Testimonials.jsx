...
const data = [
  {
    ...
    review:
      '"David is not only smart and hardworking, he’s also a natural leader. He has a positive influence on people around him. He is one of the most passionate people I know. The crypto industry needs people like David."',
  },
  {
    avatar: gerard,
  ...
  },
  {
    ...
    review:
      '"David is an excellent person to work with, and has demonstrated the ability to grasp complex ideas with ease. When collaborating on projects, he exhibits a keen eye for details and displays an aptitude for creative problem-solving."',
  },
  {
    avatar: zach,
    refName: "Zach Queen",
    ...
    review:
      '"Dave is one of the most talented and hard working people I know. A joy to work with and an asset to any team. His leadership ability, problem solving skills and work ethic are bar none."',
  },
  {
    avatar: ken,
            ...
            <SwiperSlide className="testimonial">
              <div className="ref__avatar">
                <img
                  className="ref__img"
                  src={avatar}
                  alt="a good friend of mine"
                />
              </div>
              <h4 className="ref__name">{refName}</h4>
              <h5 className="ref__title">{refTitle}</h5>
              <a className="ref__social" href={refSocial} target="_blank">
                <BsLinkedin />
              </a>
